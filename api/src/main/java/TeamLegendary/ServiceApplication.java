package TeamLegendary;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.godaddy.logging.Logger;
import TeamLegendary.bundles.GuiceBundleProvider;
import TeamLegendary.handlers.ParameterHandlerProvider;
...
public class ServiceApplication extends Application<ServiceConfiguration> {
    ...
    private BeanConfig getPublicSwagger(final Environment environment) {
        ...
        swagConfig.setTitle("ReadingListService API");
        swagConfig.setDescription("ReadingListService API");
        ...
        swagConfig.setContact("admin@ReadingListService.com");
